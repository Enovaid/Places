...
//        let location = CLLocationCoordinate2D(latitude: 43.2220, longitude: 76.8512)
//        let region = MKCoordinateRegion(center: location, span: MKCoordinateSpan(latitudeDelta: 20, longitudeDelta: 20))
//        self.mapView.setRegion(region, animated: true)
//
//        let pin = customPin(pinTitle: "ALMATY", pinSubtitle: "cnjhcbehechceehcfvcfjdhbcvjfhvf", location: location)
...
//            annotation.subtitle = "fncjdfc"
//            print(type(of: coordinates.latitude))
